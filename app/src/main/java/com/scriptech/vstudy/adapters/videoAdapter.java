...
//import com.scriptech.vstudy.ui.fragments.videoPlayer.VideoPlayer;
...
//
//    public videoAdapter(ArrayList<videoModel> modelArrayList, Context context) {
...
//        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.card_video, parent, false));
//    }
//
//    @Override
